...
#define DT_INFO(msg)  debugtools::Logger::Log(debugtools::LogLevel::Info, msg)
#define DT_WARN(msg)  debugtools::Logger::Log(debugtools::LogLevel::Warning, msg)
#define DT_ERROR(msg) debugtools::Logger::Log(debugtools::LogLevel::Error, msg)
