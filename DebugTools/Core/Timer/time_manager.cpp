...
// 		//TODO DEAL WITH THIS //TODO DEAL WITH THIS debugtools::Logger::Log(debugtools::LogLevel::Info, "Time Managter Init");
// 		//m_Timers.clear();
// 	}
//
// 	TimerManager::~TimerManager() {
// 		//TODO DEAL WITH THIS debugtools::Logger::Log(debugtools::LogLevel::Info, "TimerManager destroyed, all timers cleared.");
// 	}
//
//
//
...
//         if (FindTimer(id))
//         {
// 			//TODO DEAL WITH THIS debugtools::Logger::Log(debugtools::LogLevel::Warning,
...
//         {
// 			//TODO DEAL WITH THIS debugtools::Logger::Log(debugtools::LogLevel::Info, "Succesfully setted timer with id '" + id + "' as a current Timer");
// 			return true;
//         }
//         else
//         {
...
//         }
// 		//TODO DEAL WITH THIS debugtools::Logger::Log(debugtools::LogLevel::Warning, "Failed to set current timer with id '" + id + "'. Please check if the timer exists in TimerManager.");
// 		return false;
//     }
//
...
//         else
//         {
//             //TODO DEAL WITH THIS debugtools::Logger::Log(debug_conf,debugtools::LogLevel::Info,
//             "m_Current : nullptr, please choose the timere using | bool TimerManager::SetCurrent(const std::string& id) | " );
//         }
//         //m_Current->GetId()
// 		//TODO DEAL WITH THIS debugtools::Logger::Log(debug_conf, debugtools::LogLevel::Info, "Started timer '");
//     }
//
...
//         if (m_Current)
//         {
//             //TODO DEAL WITH THIS debugtools::Logger::Log(debug_conf, debugtools::LogLevel::Info, "Stopping timer '");
//            ////TODO DEAL WITH THIS debugtools::Logger::Log(debugtools::LogLevel::Info, "Stopped timer '" + m_Current->GetId() + "'. Elapsed time: " + std::to_string(m_Current->ElapsedMs()) + " ms.");
//             GetElapsedMs();
//             m_Current->Stop();
//         }
//     }
...
//         if (!m_Current)
//         {
// 			//TODO DEAL WITH THIS debugtools::Logger::Log(debugtools::LogLevel::Error, "No current timer set. Please set a timer to get elapsed time.");
//             return 0;
//         }
//
// 		//TODO DEAL WITH THIS debugtools::Logger::Log(debugtools::LogLevel::Info,
...
// //
// //	TimerManager::TimerManager() {
// //		//TODO DEAL WITH THIS debugtools::Logger::Log(debugtools::LogLevel::Info, "Time Managter Init");
// //		//m_Timers.clear();
// //	}
// //
// //	TimerManager::~TimerManager() {
...
// //			{
// //				//TODO DEAL WITH THIS debugtools::Logger::Log(LogLevel::Warning,
...
// //		if (m_Timers.empty())
// //		{
// //			//TODO DEAL WITH THIS debugtools::Logger::Log(LogLevel::Warning, "No timers available.");
// //			return;
// //		}
// //
// //		for (auto& timer : m_Timers)
...
// //		if (!m_CurrentTimer)
// //		{
// //			//TODO DEAL WITH THIS debugtools::Logger::Log(debugtools::LogLevel::Warning, "No current timer set. Please set a timer before starting.");
// //			return;
// //		}
// //
